...
from woocommerce_softland.tasks.utils import API, APIWithRequestLogging
from woocommerce_softland.woocommerce.doctype.woocommerce_order.woocommerce_order import (
	WC_ORDER_DELIMITER,
	WooCommerceOrder,
	WooCommerceOrderAPI,
)
...
class TestWooCommerceOrder(FrappeTestCase):
	...
	@patch(
		"woocommerce_softland.woocommerce.doctype.woocommerce_order.woocommerce_order.WooCommerceOrder.update_shipment_tracking"
	)
...
class TestAPIWithRequestLogging(FrappeTestCase):
	...
	@patch(
		"woocommerce_softland.woocommerce.doctype.woocommerce_order.woocommerce_order.frappe.enqueue"
	)
