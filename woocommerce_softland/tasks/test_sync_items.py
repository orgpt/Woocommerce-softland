...
from woocommerce_softland.tasks.sync_items import ERPNextItemToSync, SynchroniseItem
from woocommerce_softland.woocommerce.woocommerce_api import (
	generate_woocommerce_record_name_from_domain_and_id,
)


@patch("woocommerce_softland.tasks.sync_items.run_item_sync")
...
class TestWooCommerceSync(FrappeTestCase):
	...
	@patch("woocommerce_softland.tasks.sync_items.frappe")
	...
	@patch("woocommerce_softland.tasks.sync.frappe")
	...
	@patch("woocommerce_softland.tasks.sync_items.json")
	...
	@patch("woocommerce_softland.tasks.sync_items.get_item_price_rate")
