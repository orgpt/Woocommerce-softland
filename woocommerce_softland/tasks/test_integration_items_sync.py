...
from woocommerce_softland.tasks.test_integration_helpers import TestIntegrationWooCommerce
from woocommerce_softland.woocommerce.woocommerce_api import (
	generate_woocommerce_record_name_from_domain_and_id,
)


@patch("woocommerce_softland.tasks.sync_items.frappe.log_error")
