...
def execute():
	"""
	Try to get settings from deprecated "Woocommerce Settings" (erpnext) and "WooCommerce Additional Settings" (woocommerce_softland) doctypes
	"""
	try:
		...
		sync_fixtures("woocommerce_softland")
