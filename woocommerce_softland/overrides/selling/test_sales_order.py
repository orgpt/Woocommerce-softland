...
from woocommerce_softland.overrides.selling.sales_order import (
...
@patch("woocommerce_softland.overrides.selling.sales_order.get_woocommerce_order")
class TestCustomSalesOrder(FrappeTestCase):
	...
	@patch("woocommerce_softland.overrides.selling.sales_order.frappe")
